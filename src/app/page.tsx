...
function TransportCard({ opt }: { opt: TransportOption }) {
  return (
...
function VariantCard({
  ...
  return (
    ...
    >
      ...
      <div>
        <Eyebrow>{TIER_LABELS[variant.tier]}</Eyebrow>
    ...
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <section className="border-x border-neutral-200 max-w-[1280px] mx-auto">
        <div className="px-6 py-20 md:py-28 grid md:grid-cols-5 gap-12 items-center">
          <div className="md:col-span-3">
            <Eyebrow>ИИ-ПЛАНИРОВЩИК ПУТЕШЕСТВИЙ</Eyebrow>
      ...
      <section id="form" className="border-x border-neutral-200 max-w-[1280px] mx-auto">
        <div className="px-6 py-16">
          <Eyebrow>СПРОЕКТИРУЙТЕ ПОЕЗДКУ</Eyebrow>
            ...
            <div className="px-6 py-16">
              ...
              {result && (
                <div className="space-y-12">
                  {/* destination + summary */}
                  <div>
                    <Eyebrow>3 ГОТОВЫХ ВАРИАНТА</Eyebrow>
                  ...
                  <div>
                    ...
                    <div className="hidden lg:grid lg:grid-cols-3 gap-6">
                      {result.variants.map((v) => (
                        <VariantCard key={v.tier} variant={v} recommended={v.tier === "balanced"} />
                      ))}
                    </div>
                    {/* mobile: show active variant */}
                    <div className="lg:hidden">
                      {activeVariant && (
                        <VariantCard variant={activeVariant} recommended={activeVariant.tier === "balanced"} />
                      )}
                    </div>
                  </div>
